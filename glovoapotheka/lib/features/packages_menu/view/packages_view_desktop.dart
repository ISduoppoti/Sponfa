...
class ProductPackagesPageDesktop extends StatelessWidget {
  final String productId;

  const ProductPackagesPageDesktop({
    super.key,
...
class ProductPackagesView extends StatelessWidget {
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildPackageCard(context, packages[index], state.productDetail.description, state.productDetail.strength, state.productDetail.form);
          },
        );
      },
    );
  ...
  Widget _buildPackageCard(BuildContext context, PackageAvailabilityInfo package, descr, strength, form) {
    ...
    return _HoverablePackageCard(
      onTap: () {
        context.go(
          '/packages/$productId/package_details/${package.packageId}?descr=${Uri.encodeComponent(descr)}&strength=${Uri.encodeComponent(strength)}&form=${Uri.encodeComponent(form)}',
        );
      },
      child: Container(
        decoration: BoxDecoration(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            cart.addItem(CartItem(id: package.packageId, name: package.displayName, imageUrls: package.imageUrls, price: package.lowestPrice));
